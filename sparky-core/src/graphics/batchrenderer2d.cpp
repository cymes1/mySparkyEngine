...
namespace Sparky { namespace Graphics {
	...
	{
		const Math::vec3& position = renderable->position();
		const Math::vec2& size = renderable->size();
		const Math::vec4& color = renderable->color();
		...
		//const Math::vec3& pos = *m_transformationBack * position;
